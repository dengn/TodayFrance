...
public class MainActivity extends AppCompatActivity implements NewsListFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        mAdapter = new DrawerListAdapter(TITLES, ICONS, NAME, EMAIL, PROFILE);       // Creating the Adapter of MyAdapter class(which we are going to see in a bit)
        ...
        if (savedInstanceState == null) {
            ...
            transaction.replace(R.id.fragment_layout, MainFragment.newInstance());
            transaction.commit();
        }
    }
